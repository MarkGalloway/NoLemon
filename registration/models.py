...
class RegistrationProfile(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, unique=True, verbose_name='user')
    ...
    def activation_key_expired(self):
        ...
        Returns: `True` if the keyhas expired.
    ...
    def send_activation_email(self, site):
        ...
        self.player.email_user(subject, message, settings.DEFAULT_FROM_EMAIL)